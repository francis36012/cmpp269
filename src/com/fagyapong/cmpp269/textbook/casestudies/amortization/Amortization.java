package com.fagyapong.cmpp269.textbook.casestudies.amortization;
...
public class Amortization {
	...
	/**
	 * The constructor accepts the loan amount, the annual interest rate, and
	 * the number of years of the loan as arguments. The private method
	 * CalcPayment is then called.
	 * 
	 * @param loan
	 *            The loan amount.
	 * @param rate
	...
	/**
	 * The calcPayment method calculates the monthly payment amount. The result
	 * is stored in the payment field.
	 */
	...
	/**
	 * The saveReport method saves the amortization report to the file named by
	 * the argument.
	 * 
	 * @param filename
	...
	public void saveReport(String filename) throws IOException {
		...
		for (int month = 1; month <= getNumberOfPayments(); month++) {
			...
			outputFile.println(month + "\t" + dollar.format(monthlyInterest)
