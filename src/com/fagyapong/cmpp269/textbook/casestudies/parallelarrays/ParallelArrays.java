package com.fagyapong.cmpp269.textbook.casestudies.parallelarrays;
...
public class ParallelArrays {
	...
	/**
	 * The getPayData method accepts as arguments arrays for employees' hours
	 * and pay rates. The user enters values for these arrays.
	 */
	...
	private static void getPayData(int[] hours, double[] payRates) {
		...
		for (int i = 0; i < hours.length; i++) {
			...
			System.out.printf("Enter the hours worked by employee #%d: ",
					(i + 1));
			hours[i] = keyboard.nextInt();

			// Get the hourly pay rate for this employee.
			System.out.printf("Enter the hourly pay rate for employee #%d: ",
					(i + 1));
	...
	/**
	 * The displayGrossPay method accepts as arguments arrays for employees'
	 * hours and pay rates. The method uses these arrays to calculate and
	 * display each employee's gross pay.
	 */
