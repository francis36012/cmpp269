package com.fagyapong.cmpp269.textbook.casestudies.texteditor;
...
public class TextEditor extends JFrame {
	...
	/**
	 * Private inner class that handles the event that is generated when the
	 * user selects Open from the file menu.
	 */
	...
	private class SaveListener implements ActionListener {
		 ...
		 * The method returns true if the file was saved successfully, or false
